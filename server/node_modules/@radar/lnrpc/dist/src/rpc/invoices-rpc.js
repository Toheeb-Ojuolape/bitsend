...
exports.createInvoicesRpc = void 0;
 ...
 */
function createInvoicesRpc(userConfig) {
    return __awaiter(this, void 0, void 0, function () {
        var rootPath, lndProtosRootPath, protoFilePath, config, invoices, server, grpcLoader, grpc, includeDefaults, credentials, grpcPkgObj, invoicesrpc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pkg_dir_1.default(__dirname)];
                case 1:
                    rootPath = _a.sent();
                    lndProtosRootPath = path_1.join(rootPath, "lnd/" + package_json_1.default.config['lnd-release-tag']);
                    protoFilePath = path_1.join(lndProtosRootPath, '/invoicesrpc/invoices.proto');
                    config = __assign(__assign({}, defaults_1.defaults), userConfig);
                    invoices = config.invoices, server = config.server, grpcLoader = config.grpcLoader, grpc = config.grpc, includeDefaults = config.includeDefaults;
                    return [4 /*yield*/, create_credentials_1.createCredentials(config)];
                case 2:
                    credentials = _a.sent();
                    grpcPkgObj = create_grpc_object_1.createGrpcObject({
                    ...
                    invoicesrpc = Object.create(null, {
                        description: { value: grpcPkgObj },
                        invoices: {
                            value: invoices || services_1.createInvoices({
                                grpcPkgObj: grpcPkgObj,
                                server: server,
                                credentials: credentials,
                            }),
                        },
                    });
                    return [2 /*return*/, new Proxy(invoicesrpc, {
                            /**
...
exports.createInvoicesRpc = createInvoicesRpc;
