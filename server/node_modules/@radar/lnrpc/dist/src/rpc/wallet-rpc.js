...
exports.createWalletRpc = void 0;
 ...
 */
function createWalletRpc(userConfig) {
    return __awaiter(this, void 0, void 0, function () {
        var rootPath, lndProtosRootPath, protoFilePath, config, walletKit, server, grpcLoader, grpc, includeDefaults, credentials, grpcPkgObj, walletrpc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    protoFilePath = path_1.join(lndProtosRootPath, '/walletrpc/walletkit.proto');
                    config = __assign(__assign({}, defaults_1.defaults), userConfig);
                    walletKit = config.walletKit, server = config.server, grpcLoader = config.grpcLoader, grpc = config.grpc, includeDefaults = config.includeDefaults;
                ...
                case 2:
                    ...
                    walletrpc = Object.create(null, {
                        description: { value: grpcPkgObj },
                        walletKit: {
                            value: walletKit || services_1.createWalletKit({
                    ...
                    return [2 /*return*/, new Proxy(walletrpc, {
                            /**
...
exports.createWalletRpc = createWalletRpc;
