...
exports.createAutopilotRpc = void 0;
 ...
 */
function createAutopilotRpc(userConfig) {
    return __awaiter(this, void 0, void 0, function () {
        var rootPath, protoFilePath, config, autopilot, server, grpcLoader, grpc, includeDefaults, credentials, grpcPkgObj, autopilotrpc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pkg_dir_1.default(__dirname)];
                case 1:
                    rootPath = _a.sent();
                    protoFilePath = path_1.join(rootPath, "lnd/" + package_json_1.default.config['lnd-release-tag'] + "/autopilotrpc/autopilot.proto");
                    config = __assign(__assign({}, defaults_1.defaults), userConfig);
                    autopilot = config.autopilot, server = config.server, grpcLoader = config.grpcLoader, grpc = config.grpc, includeDefaults = config.includeDefaults;
                ...
                case 2:
                    ...
                    autopilotrpc = Object.create(null, {
                        description: { value: grpcPkgObj },
                        autopilot: {
                            value: autopilot || services_1.createAutopilot({
                    ...
                    return [2 /*return*/, new Proxy(autopilotrpc, {
                            /**
...
exports.createAutopilotRpc = createAutopilotRpc;
