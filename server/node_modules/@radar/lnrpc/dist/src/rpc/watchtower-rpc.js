...
exports.createWatchtowerRpc = void 0;
 ...
 */
function createWatchtowerRpc(userConfig) {
    return __awaiter(this, void 0, void 0, function () {
        var rootPath, protoFilePath, config, watchtower, server, grpcLoader, grpc, includeDefaults, credentials, grpcPkgObj, watchtowerrpc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pkg_dir_1.default(__dirname)];
                case 1:
                    rootPath = _a.sent();
                    protoFilePath = path_1.join(rootPath, "lnd/" + package_json_1.default.config['lnd-release-tag'] + "/watchtowerrpc/watchtower.proto");
                    config = __assign(__assign({}, defaults_1.defaults), userConfig);
                    watchtower = config.watchtower, server = config.server, grpcLoader = config.grpcLoader, grpc = config.grpc, includeDefaults = config.includeDefaults;
                ...
                case 2:
                    ...
                    watchtowerrpc = Object.create(null, {
                        description: { value: grpcPkgObj },
                        watchtower: {
                            value: watchtower || services_1.createWatchtower({
                    ...
                    return [2 /*return*/, new Proxy(watchtowerrpc, {
                            /**
...
exports.createWatchtowerRpc = createWatchtowerRpc;
