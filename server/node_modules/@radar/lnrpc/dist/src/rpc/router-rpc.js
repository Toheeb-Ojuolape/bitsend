...
exports.createRouterRpc = void 0;
 ...
 */
function createRouterRpc(userConfig) {
    return __awaiter(this, void 0, void 0, function () {
        var rootPath, lndProtosRootPath, protoFilePath, config, router, server, grpcLoader, grpc, includeDefaults, credentials, grpcPkgObj, routerrpc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    protoFilePath = path_1.join(lndProtosRootPath, '/routerrpc/router.proto');
                    config = __assign(__assign({}, defaults_1.defaults), userConfig);
                    router = config.router, server = config.server, grpcLoader = config.grpcLoader, grpc = config.grpc, includeDefaults = config.includeDefaults;
                ...
                case 2:
                    ...
                    routerrpc = Object.create(null, {
                        description: { value: grpcPkgObj },
                        router: {
                            value: router || services_1.createRouter({
                    ...
                    return [2 /*return*/, new Proxy(routerrpc, {
                            /**
...
exports.createRouterRpc = createRouterRpc;
