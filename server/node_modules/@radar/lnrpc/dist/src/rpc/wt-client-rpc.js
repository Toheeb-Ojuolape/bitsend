...
exports.createWtClientRpc = void 0;
 ...
 */
function createWtClientRpc(userConfig) {
    return __awaiter(this, void 0, void 0, function () {
        var rootPath, protoFilePath, config, watchtowerClient, server, grpcLoader, grpc, includeDefaults, credentials, grpcPkgObj, wtclientrpc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pkg_dir_1.default(__dirname)];
                case 1:
                    rootPath = _a.sent();
                    protoFilePath = path_1.join(rootPath, "lnd/" + package_json_1.default.config['lnd-release-tag'] + "/wtclientrpc/wtclient.proto");
                    config = __assign(__assign({}, defaults_1.defaults), userConfig);
                    watchtowerClient = config.watchtowerClient, server = config.server, grpcLoader = config.grpcLoader, grpc = config.grpc, includeDefaults = config.includeDefaults;
                ...
                case 2:
                    ...
                    wtclientrpc = Object.create(null, {
                        description: { value: grpcPkgObj },
                        watchtowerClient: {
                            value: watchtowerClient || services_1.createWatchtowerClient({
                    ...
                    return [2 /*return*/, new Proxy(wtclientrpc, {
                            /**
...
exports.createWtClientRpc = createWtClientRpc;
