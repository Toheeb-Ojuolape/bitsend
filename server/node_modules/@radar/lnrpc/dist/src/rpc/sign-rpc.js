 ...
 */
function createSignRpc(userConfig) {
    return __awaiter(this, void 0, void 0, function () {
        var rootPath, protoFilePath, config, signer, server, grpcLoader, grpc, includeDefaults, credentials, grpcPkgObj, signrpc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pkg_dir_1.default(__dirname)];
                case 1:
                    rootPath = _a.sent();
                    protoFilePath = path_1.join(rootPath, "lnd/" + package_json_1.default.config['lnd-release-tag'] + "/signrpc/signer.proto");
                    config = __assign(__assign({}, defaults_1.defaults), userConfig);
                    signer = config.signer, server = config.server, grpcLoader = config.grpcLoader, grpc = config.grpc, includeDefaults = config.includeDefaults;
                ...
                case 2:
                    ...
                    signrpc = Object.create(null, {
                        description: { value: grpcPkgObj },
                        signer: {
                            value: signer || services_1.createSigner({
                    ...
                    return [2 /*return*/, new Proxy(signrpc, {
                            /**
...
exports.createSignRpc = createSignRpc;
