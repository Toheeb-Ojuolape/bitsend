 ...
 */
function createChainRpc(userConfig) {
    return __awaiter(this, void 0, void 0, function () {
        var rootPath, protoFilePath, config, chainNotifier, server, grpcLoader, grpc, includeDefaults, credentials, grpcPkgObj, chainrpc;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pkg_dir_1.default(__dirname)];
                case 1:
                    rootPath = _a.sent();
                    protoFilePath = path_1.join(rootPath, "lnd/" + package_json_1.default.config['lnd-release-tag'] + "/chainrpc/chainnotifier.proto");
                    config = __assign(__assign({}, defaults_1.defaults), userConfig);
                    chainNotifier = config.chainNotifier, server = config.server, grpcLoader = config.grpcLoader, grpc = config.grpc, includeDefaults = config.includeDefaults;
                ...
                case 2:
                    ...
                    chainrpc = Object.create(null, {
                        description: { value: grpcPkgObj },
                        chainNotifier: {
                            value: chainNotifier || services_1.createChainNotifier({
                    ...
                    return [2 /*return*/, new Proxy(chainrpc, {
                            /**
...
exports.createChainRpc = createChainRpc;
